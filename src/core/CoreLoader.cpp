...
namespace CoreLoader
{
    ...
    namespace MapIds
    {
        LevelData::MapType COUNTRYSIDE;
        LevelData::MapType DESERT;
        LevelData::MapType FOREST;
        LevelData::MapType ICE;
        LevelData::MapType MOUNTAINS;
        LevelData::MapType SEA;
        LevelData::MapType BEACH;
        LevelData::MapType SWAMPLAND;
        LevelData::MapType CITY;
        LevelData::MapType MOTORWAY;
        LevelData::MapType FOREST_TRAILS;
    }
    ...
    {
        Cars::NORMAL = game->gpo.registerCarType((new CarType("default"))->setRarities(      {2,2,2,2,2,2,2,2,2,2,2}             )->setMaxHealth(1));
        Cars::LORRY = game->gpo.registerCarType((new CarType("lorry"))->setRarities(         {4,4,4,15,13,5,2,5,10,4,15}         )->setMaxHealth(3));
        Cars::RARE = game->gpo.registerCarType((new CarType("default"))->setRarities(        {5,3,3,4,7,8,10,5,5,3,5}            )->setMaxHealth(2));
        Cars::BUS = game->gpo.registerCarType((new CarType("bus"))->setRarities(             {10,3,14,8,3,3,5,3,5,8,3}           )->setMaxHealth(5));
        Cars::AMBULANCE = game->gpo.registerCarType((new CarType("ambulance"))->setRarities( {10,3,10,15,20,5,3,10,3,3,6}        )->setMaxHealth(4));
        Cars::RALLY = game->gpo.registerCarType((new CarType("rally"))->setRarities(         {4,20,5,25,10,20,10,20,20,5,20}     )->setMaxHealth(2));
        Cars::BOMB = game->gpo.registerCarType((new CarType("bomb"))->setRarities(           {15,15,15,15,15,15,15,15,15,15,15}  )->setMaxHealth(1));
        Cars::FIREMAN = game->gpo.registerCarType((new CarType("fireman"))->setRarities(     {5,7,3,10,8,12,4,10,5,5,12}         )->setMaxHealth(5));
        Cars::TANK = game->gpo.registerCarType((new CarType("tank"))->setRarities(           {10,7,15,20,25,10,20,20,25,30,10}   )->setMaxHealth(10));
        Cars::OLD = game->gpo.registerCarType((new CarType("old"))->setRarities(             {5,20,8,10,15,5,15,20,15,15,5}      )->setMaxHealth(2));
        Cars::ARMORED = game->gpo.registerCarType((new CarType("lorry"))->setRarities(       {20,14,30,40,50,15,40,10,12,15,5}   )->setMaxHealth(15));
        Cars::TRAIN = game->gpo.registerCarType((new CarType("train"))->setRarities(         {20,50,5,50,25,10,5,30,10,10,20}    )->setMaxHealth(10));
    }
