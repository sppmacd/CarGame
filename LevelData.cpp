...
void LevelData::init()
{
	...
	Maps::countryside.setCarCreationSpeed(80);
	...
	Maps::countryside.setCarCreationSpeed(60);
	...
	Maps::countryside.setCarCreationSpeed(90);
	...
	Maps::countryside.setCarCreationSpeed(85);
}
