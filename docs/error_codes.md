...
This file describes error that may occur when playing the game.
TODO: image
...
## Other errors
* If the game crashes with ````cg.exe stopped working...```` message or without showing an error, this may be:
