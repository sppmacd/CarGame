...
void CarType::init()
{
	...
	// TODO: NEW CARS!
	game->registerCarType(CarType(Car::RALLY, "rally").setRarities(         {4,20,5,25,10,20,10,20,20,5,20}     ).setMaxHealth(2)); // !!! TEXTURES !!!
	...
	game->registerCarType(CarType(Car::OLD, "default").setRarities(         {5,20,8,10,15,5,15,20,15,15,5}      ).setMaxHealth(2)); // !!! TEXTURES !!!
	game->registerCarType(CarType(Car::ARMORED, "lorry").setRarities(       {20,14,30,40,50,15,40,10,12,15,5}   ).setMaxHealth(15)); // !!! TEXTURES !!!
